   ...
   <div class="container-fluid">
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Caja</h1>
            ...
            <!--<div class="col-lg-8">
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Nombre: </label>
                            <input class="form-control" type="text" placeholder="Ann">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Apellidos: </label>
                            <input class="form-control" type="text" placeholder="Nava">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>E-mail: </label>
                        ...
                        <div class="col-md-6 form-group">
                            <label>Numero Telefonico: </label>
                            <input class="form-control" type="text" placeholder="+52 722 789 6768">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Calle: </label>
                            <input class="form-control" type="text" placeholder="123 Morelos">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Referencia: </label>
                        ...
                        <div class="col-md-6 form-group">
                            <label>Ciudad: </label>
                            <input class="form-control" type="text" placeholder="Toluca">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Estado: </label>
                            <input class="form-control" type="text" placeholder="Estado de México">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Código Postal:</label>
                            <input class="form-control" type="text" placeholder="50 - 000">
                        </div>
                        <div class="col-md-12 form-group">
                            <div class="custom-control custom-checkbox">
            ...
            <div class="col-lg-4">
                <div class="card border-secondary mb-5">
                    <div class="card-header bg-secondary border-0">
                        <h4 class="font-weight-semi-bold m-0">Total de Compra: </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <p>Camisa de punto de unicolor sin mangas informal, de verano, para mujer</p>
                            <p>$199.99</p>
                        </div>
                        <div class="d-flex justify-content-between">
                            <p>Top de tirantes de punto con cuello redondo y botones</p>
                            <p>$550.00</p>
                        </div>
                        <hr class="mt-0">
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            <h6 class="font-weight-medium">Subtotal</h6>
                            <h6 class="font-weight-medium">$1529.99</h6>
                        </div>
                        <div class="d-flex justify-content-between">
                            <h6 class="font-weight-medium">Envio</h6>
                            <h6 class="font-weight-medium">$199.99</h6>
                        </div>
                    </div>
