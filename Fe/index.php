...
// Filtrar los productos en base a los IDs
$productosTendencia = array_filter($productos, function($producto) use ($tendenciaIDs) {
    return in_array($producto['id'], $tendenciaIDs);
});

// IDs de productos recién llegados
$recienLlegadosIDs = range(14, 21);

// Filtrarlos del arreglo de todos los productos
$recienLlegados = array_filter($productos, function($producto) use ($recienLlegadosIDs) {
    return in_array($producto['id'], $recienLlegadosIDs);
});
...
<body>
                    ...
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                ...
                                <a href="" class="dropdown-item">Aaccesorios</a>
                                <a href="" class="dropdown-item">Zapatos</a>
                            </div>
                        </div>
                        <a href="" class="nav-item nav-link">Lo más vendido</a>
                         <a href="" class="nav-item nav-link">Tendencias</a>
                        ...
                        <a href="" class="nav-item nav-link">Ropa de Baño</a>
                        <a href="" class="nav-item nav-link">Ropa de ejercicio</a>
                        <a href="" class="nav-item nav-link">Ecenciales</a>
                        <a href="" class="nav-item nav-link">Liquidación</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Celebra lo que Eres Hoy</h3>
                        ...
                        <div class="carousel-item" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% de Descuento en tu primera compra</h4>
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Y lo que Estás por Descubrir</h3>
                                    <a href="" class="btn btn-light py-2 px-3">Compra Ahora</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <a class="carousel-control-prev" href="#header-carousel" data-slide="Anterior">
                        <div class="btn btn-dark" style="width: 45px; height: 45px;">
                            <span class="carousel-control-prev-icon mb-n2"></span>
                        </div>
                    </a>
                    <a class="carousel-control-next" href="#header-carousel" data-slide="Siguiente">
                        <div class="btn btn-dark" style="width: 45px; height: 45px;">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                    ...
                    <h5 class="font-weight-semi-bold m-0">Evios Seguros</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
                    <h1 class="fas fa-exchange-alt text-primary m-0 mr-3"></h1>
                    <h5 class="font-weight-semi-bold m-0">15-Días para Devoluciones</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center border mb-4" style="padding: 30px;">
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">Colección de Verano</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/Catalogo_1.jpg" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">Más Vendidos</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/Catalogo_2.jpg" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">Nuevo</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/Catalogo_3.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Joyeria</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">Elige tu MOOD</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/Catalogo_4.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Sombreros | Gorros</h5>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">Que combine con tu Vibe</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/Catalogo_5.jpg" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right">Siempre Contigo</p>
                    <a href="" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid" src="img/Catalogo_6.jpg" alt="">
                    </a>
                    <h5 class="font-weight-semi-bold m-0">Basicos</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid offer pt-5">
        <div class="row px-xl-5">
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5" style="height: 100%;">
                    <img src="img/Oferta_PV.jpg" alt="">
                    <div class="position-relative" style="z-index: 1;">
                        <h5 class="text-uppercase text-primary mb-3">20% de descuento</h5>
                        <h1 class="mb-4 font-weight-semi-bold">Primavera | Verano</h1>
                        <a href="" class="btn btn-outline-primary py-md-2 px-md-3">Compra Ahora</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-left text-white mb-2 py-5 px-5" style="height: 100%;">
                    <img src="img/Coleccion_nueva.jpg" alt="">
                    <div class="position-relative" style="z-index: 1;">
                        <h5 class="text-uppercase text-primary mb-3">En camino</h5>
                        <h1 class="mb-4 font-weight-semi-bold"> Otoño | Invierno </h1>
                        <a href="" class="btn btn-outline-primary py-md-2 px-md-3">Echa un Vistazo</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">En Tendencia</span></h2>
        </div>

    <div class="row px-xl-5 pb-3">
    <?php foreach ($productosTendencia as $producto): ?>
        <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
            <div class="card product-item border-0 mb-4">
                ...
                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <h6 class="text-muted ml-2"><del>$<?= number_format($producto['precio'], 2) ?></del></h6>
                    </div>
                </div>
        ...
        <div class="row justify-content-md-center py-5 px-xl-5">
            <div class="col-md-6 col-12 py-5">
                <div class="text-center mb-2 pb-2">
                    ...
                    <p>Suscríbete y recibe antes que nadie nuestras colecciones, descuentos secretos y pequeñas dosis de inspiración para reinventarte cada día.
                        Tu estilo florece aquí 🌸
                    </p>
                </div>
                <form action="">
                    <div class="input-group">
                        <input type="text" class="form-control border-white p-4" placeholder="tu email va acá">
                        <div class="input-group-append">
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Recien Llegados</span></h2>
        </div>

        <div class="row px-xl-5 pb-3">
            <?php foreach ($recienLlegados as $producto): ?>
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="<?= $producto['imagen'] ?>" alt="<?= $producto['nombre'] ?>">
